# ROADMAP — blackboxprogramming.io

> Product roadmap for BlackBox Programming
...
- [ ] Deploy index.html to blackboxprogramming.io
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://blackboxprogramming.io with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: BlackRoad Code, RoadCode Platform, Code Review AI, Deploy Pipeline
...
**Milestone**: First paying customer through blackboxprogramming.io.
...
**Milestone**: blackboxprogramming.io is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: devtools | Products: BlackRoad Code, RoadCode Platform, Code Review AI, Deploy Pipeline*
